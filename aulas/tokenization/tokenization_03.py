...
# Função apenas para entendimento do que poderiamos fazer no pré-processamento
# o Whoosh já faz o pre-processamento de fora automatica ao definir o 'content' como TEXT no schema
def preprocess(text):
...
retrieval = boolean_search(query, index)
